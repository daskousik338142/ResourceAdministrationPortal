...
const ResourceAllocationDashboard = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      console.log('Existing allocations stats:', existingAllocationsResponse.data);
      console.log('Existing billable analytics:', existingBillableResponse.data);
      console.log('New allocations stats:', newAllocationsResponse.data);
      console.log('New billable analytics:', newBillableResponse.data);
